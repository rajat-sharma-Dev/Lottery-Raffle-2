...
contract RaffleTest is Test, CodeConstants {
    ...
    function testRaffleRevertsWHenYouDontPayEnough() public {
        ...
        vm.expectRevert(Raffle.SendMoreEth.selector);
        raffle.enterRaffle();
    }
    ...
    function testDontAllowPlayersToEnterWhileRaffleIsCalculating() public {
        ...
        vm.expectRevert(Raffle.RaffleCurrentlyRunning.selector);
        vm.prank(PLAYER);
        raffle.enterRaffle{value: raffleEntranceFee}();
    }
    ...
    function testPerformUpkeepRevertsIfCheckUpkeepIsFalse() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Raffle.UpkeepNotNeeded.selector, currentBalance, numPlayers, rState));
        raffle.performUpkeep("");
    }
